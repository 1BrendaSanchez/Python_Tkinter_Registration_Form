...
adressLabel = tk.Label(text="Address: ")
adressLabel.grid(column=0, row=2)
adressText = tk.Text(window, height=4, width=15)
adressText.grid(column=1, row=2)
